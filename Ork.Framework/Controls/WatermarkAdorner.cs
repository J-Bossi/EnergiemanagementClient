...
namespace Ork.Framework.Controls
{
  ...
  internal class WatermarkAdorner : Adorner
  {
    ...
    ///   <see cref="UIElement" /> to be adorned
    /// </param>
    ...
    /// </summary>
    /// <param name="index">
    ///   A 32-bit signed integer that represents the index value of the child <see cref="Visual" />. The value of index must
    ///   be between 0 and
    ///   <see
    ///     cref="VisualChildrenCount" />
    ///   - 1.
    /// </param>
    /// <returns>
    ///   The child <see cref="Visual" />.
    /// </returns>
