    ...
    public class MeasureAddViewModel : DocumentBase
    {
      private readonly DomainModelService.EnergyMeasure m_Model;
        ...
        public void RemoveSubMeasure(object dataContext)
        {
            ...
            if (subMeasure != null) m_Repository.SubMeasures.Remove(subMeasure.Model);
        ...
        public string Consumer // Property für Verbraucher, z.B: M25
        {
        ...
        {
            return Enumerable.ToArray<SubMeasureViewModel>(m_Repository.SubMeasures.Select(m_SubMeasureViewModelFactory.CreateFromExisting));
        }
        ...
        {
            byte[] buffer = FileHelpers.GetByeArrayFromUserSelectedFile("Image Files |*.jpeg;*.png;*.jpg;*.gif");
        ...
        public void AddDocument()
        {
            ...
            byte[] binarySourceDocument = FileHelpers.GetByeArrayFromUserSelectedFile(string.Empty, out filename);
        ...
        private IEnumerable<ResponsibleSubjectViewModel> SearchInResponsibleObjectList()
        {
            ...
            string searchText = ResponsibleSubjectSearchText.ToLower();

            IEnumerable<ResponsibleSubjectViewModel> searchResultResponsibleSubjects =
                m_ResponsibleSubjects.Where(e => (e.Infotext != null) && (e.Infotext.ToLower()
